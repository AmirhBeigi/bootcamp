...
import sty from "./PlasmicButton.module.css"; // plasmic-import: YZfod5k4_n_I/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: zdEzcvnA8Nio/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: SOdiGf5_2Kiv/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__rqSzt)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__aWq5)}
                role={"img"}
              />
            ),
